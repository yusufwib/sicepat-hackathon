...
<script>
    ...
    var leng = dataDraft.jury;
    var jumlahJuri = leng.length;
    ...
    $(document).ready(() => {
        ...
        $("#uploadform").submit(function (e) {
            ...
            console.log(valuesSubmit.contest_date)
        ...
        // INIT JURI
        $.map(dataDraft.jury, function (juri, idx) {

            let newJuri = `<div class="row mb-3">
                        <div class="col-11">
                            <label for="juri">Juri ${idx+1}</label>
                            <select class="form-control select-juri" name="juri[]">
                                <option></option>
                            </select>
                        </div>
            ...
            $('.select-juri').val(juri.id).trigger('change');
        });

        // DRAFT VAL INIT PENYELENGGARA
        $.map(dataDraft.organizer, function (panitias, idx) {
            let number = panitias.phone.slice(3)
            let organizer = `
            <div class="row row-group mb-3">
                <div class="col-11">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Nama</label>
                                <input type="text" name="nama-penyelenggara[]" class="form-control" value=${panitias.name}>
                            </div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="nomor[]" value=${number}>
                                </div>
                        </div>
                        </div>
                    </div>
