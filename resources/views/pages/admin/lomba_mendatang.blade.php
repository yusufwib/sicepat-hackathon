@extends('layout.index', ['title' => 'Daftar Lomba', 'heading' => 'Mendatang'])

@section('action-button')
<a href="/lomba/template-nomor-peserta" class="button button-outline button-info">Template No. Peserta</a>
@endsection

@section('contents')
<div class="box">
    <div class="box-head">
        <h4>Lomba Mendatang</h4>
    </div>
    <div class="box-body">
